package com.myproject.bookmanagementsystem.config;
...
import com.myproject.bookmanagementsystem.payload.response.APIErrorResponse;
...
public class APIExceptionHandlerConfig {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(APIExceptionHandlerConfig.class);
